...
class ChildWindow(QWidget):
    ...
    def initUI_new(self):
        # self.setWindowFlags(Qt.WindowCloseButtonHint)
        self.cmain_layout=QGridLayout()
        self.left_cb_layout=QGridLayout()
        self.right_ser_layout=QGridLayout()
        self.mid_show_layout=QGridLayout()
        self.setWindowTitle('设置工业相机参数')
        ...
        margin_size=10
        self.cmain_layout.setContentsMargins(margin_size,margin_size,margin_size,margin_size)
        self.cmain_layout.setSpacing(10)
        ...
        # self.cb.move(130, 20)
        self.cb.currentTextChanged.connect(self.get_device)
        self.left_cb_layout.addWidget(self.cb,0,0)

        self.ser_cb = QComboBox(self)
        # self.ser_cb.resize(120, 40)
        self.ser_cb.setMinimumSize(self.main_w//16,self.main_h//27)
        self.ser_cb.currentTextChanged.connect(self.get_ser_device)
        self.right_ser_layout.addWidget(self.ser_cb,0,0)
...
class MainWindow(QMainWindow):
    ...
    def predict(self, img):
        ...
        results = self.model.run(None, {self.model.get_inputs()[0].name: input_data})

        self.predict_index = np.argmax(results)
        pred_label = self.classes[self.predict_index]
        confident = results
        conf = float(confident[0][0][self.predict_index]*100)
    ...
    def init_pic_label(self, text):
        ...
        self.predict_label_height=self.win_height//20
        # self.predict_lable.setGeometry(QRect(150, 50, 900, 27*6))
        self.predict_lable.setMinimumSize(self.win_width,self.predict_label_height)
        ...
        self.label.setMinimumSize(self.win_width,self.win_height-self.predict_label_height)
    ...
    def initUI(self):
        ...
        # self.win_height = int(self.screenheight )
        # self.win_width = int(self.screenwidth )
        # self.win_height = int(self.screenwidth)
        # self.win_width = int(self.screenheight)
        ...
        self.left_layout=QGridLayout()
        self.right_layout=QGridLayout()
        self.right_layout.setContentsMargins(self.win_width//18,self.win_height//25,self.win_width//18,self.win_height//25)#左上右下
        ...
        self.button_width=self.win_width*0.1
        self.button_height=self.win_height*0.05
        ...
        self.button_c_open_g.setMinimumSize(self.button_width,self.button_height)
        ...
        self.button_c_open.setMinimumSize(self.button_width,self.button_height)
        ...
        self.button_c_close.setMinimumSize(self.button_width,self.button_height)
        ...
        self.button_s_predict.setMinimumSize(self.button_width,self.button_height)
        ...
        self.button_c_predict.setMinimumSize(self.button_width,self.button_height)
        ...
        self.listen_open_button.setMinimumSize(self.button_width,self.button_height)
        self.left_layout.addWidget(self.listen_open_button,6,0)
        ...
        self.listen_close_button.setMinimumSize(self.button_width,self.button_height)
        # self.listen_close_button.move(10,600)
        self.left_layout.addWidget(self.listen_close_button,7,0)
